...
class IrregularityBasicContentView: BouncesContentView {
    ...
    override init(frame: CGRect) {
        ...
        textColor = SCColor.appOrange
        highlightTextColor = SCColor.appOrange
        
        iconColor = SCColor.appWhite
        highlightIconColor = SCColor.appOrange
        
        backdropColor = SCColor.appClear
        highlightBackdropColor = SCColor.appClear
    }
...
class IrregularityContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        ...
        self.imageView.backgroundColor = SCColor.appSelected
        ...
        textColor = SCColor.appOrange
        highlightTextColor = SCColor.appOrange
        iconColor = SCColor.appBlack
        highlightIconColor = SCColor.appSelected
